  ...
  return (
    <div className="flex min-h-full flex-col bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-4 px-6 py-16">
        <h1 className="text-title font-semibold tracking-tight">Store unavailable</h1>
        ...
        <button
          type="button"
          onClick={reset}
          className="w-fit rounded-lg border border-zinc-300 bg-white px-4 py-2 text-ui font-medium transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"
        >
          Try again
        </button>
      </main>
