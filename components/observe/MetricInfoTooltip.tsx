  ...
  return (
    <span className="group/info relative inline-flex shrink-0">
      <button
        ...
        className="inline-flex h-3.5 w-3.5 cursor-pointer items-center justify-center rounded-full border border-zinc-400 text-micro font-bold leading-none text-zinc-500 transition-colors hover:border-zinc-600 hover:text-zinc-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 dark:border-zinc-500 dark:text-zinc-400 dark:hover:border-zinc-300 dark:hover:text-zinc-100 dark:focus-visible:ring-zinc-500"
      >
        {icon}
      </button>
      <span
